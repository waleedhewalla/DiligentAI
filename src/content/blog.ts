...
const posts: Post[] = [
  {
    slug: "vision-qc-pilot-what-you-need",
    publishedAt: "2026-09-26",
    updatedAt: "2026-09-26",
    author,
    readingMinutes: 5,
    category: { en: "Quality", ar: "الجودة" },
    related: { offerings: ["vision-quality-control"], capabilities: ["quality-control"], caseStudies: [] },
    title: {
      en: "Vision QC on a Fast Line: What a Pilot Actually Needs",
      ar: "الفحص البصري بالذكاء الاصطناعي على خط سريع: ما الذي يحتاجه المشروع التجريبي فعلاً",
    },
    excerpt: {
      en: "Cameras are the easy part. A vision pilot succeeds or fails on defect definitions, lighting and what happens when the model says no.",
      ar: "الكاميرات هي الجزء السهل. ينجح مشروع الفحص البصري أو يفشل بتعريف العيوب والإضاءة وما يحدث حين يرفض النموذج قطعة.",
    },
    keywords: {
      en: ["AI visual inspection", "vision quality control pilot", "defect detection manufacturing"],
      ar: ["الفحص البصري بالذكاء الاصطناعي", "مراقبة الجودة بالكاميرات", "اكتشاف العيوب في التصنيع"],
    },
    body: {
      en: [
        { type: "p", text: "Most vision projects we are asked to rescue did not fail because of the model. They failed because nobody agreed what a defect was, the lighting changed between shifts, or a rejected part had nowhere to go." },
        { type: "h2", text: "Before the first camera" },
        { type: "ul", items: ["Pick one line and three to five defect types that cost you money today.", "Write a defect catalogue with photos of accept, reject and borderline parts, signed by quality and production.", "Measure your current escape rate and false rejects, so the pilot has a baseline."] },
        { type: "h2", text: "On the line" },
        { type: "ul", items: ["Control the light: an enclosure or fixed lighting beats a better camera.", "Collect images from every shift and every material batch, not one good afternoon.", "Decide what happens on a reject: divert, stop, or flag for an inspector."] },
        { type: "p", text: "Run the model in shadow mode first, next to your inspectors, and compare. Switch to automatic rejection only when the numbers agree for several weeks." },
        { type: "quote", text: "A vision system is only as good as the defect catalogue it learned from." },
        { type: "cta", offering: "vision-quality-control" },
      ],
      ar: [
        { type: "p", text: "معظم مشروعات الفحص البصري التي يُطلب منا إنقاذها لم تفشل بسبب النموذج، بل لأن أحداً لم يتفق على تعريف العيب، أو تغيّرت الإضاءة بين الورديات، أو لم يكن للقطعة المرفوضة مسار." },
        { type: "h2", text: "قبل تركيب أول كاميرا" },
        { type: "ul", items: ["اختر خطاً واحداً ومن ثلاثة إلى خمسة أنواع من العيوب تكلفك مالاً اليوم.", "اكتب دليلاً للعيوب بصور للقطع المقبولة والمرفوضة والحدّية، يوقّعه قسما الجودة والإنتاج.", "قِس نسبة العيوب المتسربة والرفض الخاطئ الحالية ليكون للمشروع خط أساس."] },
        { type: "h2", text: "على الخط" },
        { type: "ul", items: ["تحكّم في الإضاءة: غطاء أو إضاءة ثابتة أفضل من كاميرا أغلى.", "اجمع صوراً من كل وردية وكل دفعة خامات، لا من ظهيرة واحدة جيدة.", "حدّد ما يحدث عند الرفض: تحويل القطعة أو إيقاف الخط أو تنبيه المفتش."] },
        { type: "p", text: "شغّل النموذج أولاً في وضع المراقبة بجانب المفتشين وقارن النتائج. انتقل إلى الرفض التلقائي فقط حين تتطابق الأرقام لعدة أسابيع." },
        { type: "quote", text: "نظام الفحص البصري جيد بقدر جودة دليل العيوب الذي تعلّم منه." },
        { type: "cta", offering: "vision-quality-control" },
      ],
    },
  },
  {
    slug: "predictive-maintenance-legacy-machines",
    publishedAt: "2026-09-26",
    updatedAt: "2026-09-26",
    author,
    readingMinutes: 5,
    category: { en: "Maintenance", ar: "الصيانة" },
    related: { offerings: ["machine-health", "legacy-shopfloor-connectivity"], capabilities: ["predictive-maintenance"], caseStudies: [] },
    title: {
      en: "Predictive Maintenance on 20-Year-Old Machines",
      ar: "الصيانة التنبؤية على ماكينات عمرها عشرون عاماً",
    },
    excerpt: {
      en: "You don't need a new plant to predict failures. Start with the machines whose stops hurt most and the signals you can add cheaply.",
      ar: "لا تحتاج مصنعاً جديداً لتوقع الأعطال. ابدأ بالماكينات التي يؤلم توقفها أكثر وبالإشارات التي يمكن إضافتها بتكلفة قليلة.",
    },
    keywords: {
      en: ["predictive maintenance legacy equipment", "condition monitoring retrofit", "machine health Egypt"],
      ar: ["الصيانة التنبؤية", "مراقبة حالة الماكينات القديمة", "صحة الماكينات"],
    },
    body: {
      en: [
        { type: "p", text: "Many Egyptian plants run machines older than their ERP. They have no network card and no historian, yet they are exactly the machines whose failures stop the line." },
        { type: "h2", text: "Choose where to start" },
        { type: "ul", items: ["List unplanned stops from the last 12 months and rank machines by hours lost, not by count.", "Pick two or three bottleneck machines where one stop delays the whole plan.", "Check what already exists: PLC tags, motor drives, energy meters, maintenance logs."] },
        { type: "h2", text: "Add signals cheaply" },
        { type: "ul", items: ["Vibration and temperature sensors on bearings and gearboxes, retrofitted without changing the machine.", "Motor current from the drive or a clamp meter — often the earliest sign of wear.", "An edge gateway that reads old PLCs and sends data out read-only."] },
        { type: "p", text: "The value comes from linking the warning to the production plan: a bearing that will fail in two weeks matters more if the machine is fully booked next week. Plan the repair into the schedule instead of around a breakdown." },
        { type: "quote", text: "Predict the failures that stop the plan, not every failure you can measure." },
        { type: "cta", offering: "machine-health" },
      ],
      ar: [
        { type: "p", text: "كثير من المصانع المصرية تشغّل ماكينات أقدم من نظام ERP لديها، بلا بطاقة شبكة ولا سجل بيانات، ومع ذلك فهي بالضبط الماكينات التي يوقف عطلها الخط." },
        { type: "h2", text: "اختر من أين تبدأ" },
        { type: "ul", items: ["اجمع التوقفات غير المخططة في آخر 12 شهراً ورتّب الماكينات حسب الساعات الضائعة لا عدد المرات.", "اختر ماكينتين أو ثلاثاً من ماكينات عنق الزجاجة التي يؤخر توقفها الخطة كلها.", "راجع ما هو موجود: إشارات PLC ومحركات السرعة وعدادات الطاقة وسجلات الصيانة."] },
        { type: "h2", text: "أضف الإشارات بتكلفة قليلة" },
        { type: "ul", items: ["حساسات اهتزاز وحرارة على المحامل وصناديق التروس، تُركّب دون تعديل الماكينة.", "تيار المحرك من وحدة التحكم أو بمقياس مشبكي — وغالباً ما يكون أول علامة على التآكل.", "بوابة طرفية تقرأ وحدات PLC القديمة وترسل البيانات بصلاحية قراءة فقط."] },
        { type: "p", text: "تأتي القيمة من ربط الإنذار بخطة الإنتاج: محمل سيتعطل بعد أسبوعين أهم إذا كانت الماكينة محجوزة بالكامل الأسبوع المقبل. خطّط الإصلاح داخل الجدول بدل الالتفاف حول العطل." },
        { type: "quote", text: "توقّع الأعطال التي توقف الخطة، لا كل عطل يمكنك قياسه." },
        { type: "cta", offering: "machine-health" },
      ],
    },
  },
  {
    slug: "overtime-is-a-planning-problem",
    publishedAt: "2026-09-26",
    updatedAt: "2026-09-26",
    author,
    readingMinutes: 4,
    category: { en: "HR & Workforce", ar: "الموارد البشرية" },
    related: { offerings: ["ai-production-scheduling", "shop-floor-arabic-copilot"], capabilities: ["production-scheduling"], caseStudies: [] },
    title: {
      en: "Overtime Is a Planning Problem, Not an HR Problem",
      ar: "العمل الإضافي مشكلة تخطيط لا مشكلة موارد بشرية",
    },
    excerpt: {
      en: "When the schedule is built late and without labour constraints, overtime becomes the default fix. Plan people with the production plan instead.",
      ar: "حين يُبنى الجدول متأخراً ودون قيود العمالة، يصبح العمل الإضافي الحل الافتراضي. خطّط للأفراد مع خطة الإنتاج.",
    },
    keywords: {
      en: ["reduce overtime manufacturing", "shift planning", "workforce planning factory"],
      ar: ["تقليل العمل الإضافي في المصانع", "تخطيط الورديات", "تخطيط القوى العاملة"],
    },
    body: {
      en: [
        { type: "p", text: "HR usually owns the overtime budget, but it rarely owns the cause. Overtime is decided on the shop floor, late in the week, when the plan meets reality." },
        { type: "h2", text: "Where the hours come from" },
        { type: "ul", items: ["The schedule assumes full crews, but leave and absence are known in advance.", "Critical skills sit with a few operators, so one absence stops a line.", "Late material or a breakdown pushes work into the weekend."] },
        { type: "h2", text: "What changes it" },
        { type: "ul", items: ["Derive labour demand per skill from the production plan, two to four weeks ahead.", "Keep a simple skills matrix and plan cross-training where a single person is critical.", "Re-plan with the real crew each day instead of adding hours at the end of the week."] },
        { type: "p", text: "We are co-developing a Workforce Planner with pilot customers, linked to the IPE schedule. If overtime is a line item your CFO asks about every month, we would like to hear from you." },
        { type: "quote", text: "Every overtime hour was decided by a plan that didn't know who would be there." },
        { type: "cta", offering: "ai-production-scheduling" },
      ],
      ar: [
        { type: "p", text: "عادةً ما تملك الموارد البشرية ميزانية العمل الإضافي، لكنها نادراً ما تملك سببه. فالعمل الإضافي يُقرر على أرض المصنع، في آخر الأسبوع، حين تصطدم الخطة بالواقع." },
        { type: "h2", text: "من أين تأتي الساعات" },
        { type: "ul", items: ["الجدول يفترض طواقم كاملة، رغم أن الإجازات والغياب معروفة مسبقاً.", "المهارات الحرجة عند عدد قليل من المشغلين، فغياب واحد يوقف خطاً.", "تأخر الخامات أو عطل ماكينة يدفع العمل إلى نهاية الأسبوع."] },
        { type: "h2", text: "ما الذي يغيّر ذلك" },
        { type: "ul", items: ["اشتق احتياج العمالة لكل مهارة من خطة الإنتاج قبل أسبوعين إلى أربعة.", "احتفظ بمصفوفة مهارات بسيطة وخطط للتدريب المتبادل حيث يكون شخص واحد حرجاً.", "أعد التخطيط يومياً بالطاقم الفعلي بدل إضافة ساعات في آخر الأسبوع."] },
        { type: "p", text: "نطوّر مع عملاء تجريبيين مخطط القوى العاملة مرتبطاً بجدول IPE. إن كان العمل الإضافي بنداً يسأل عنه مديرك المالي كل شهر، يسعدنا أن نسمع منك." },
        { type: "quote", text: "كل ساعة عمل إضافي قررتها خطة لم تكن تعرف من سيحضر." },
        { type: "cta", offering: "ai-production-scheduling" },
      ],
    },
  },
  {
    slug: "safety-stock-from-forecast-error",
    publishedAt: "2026-09-26",
    updatedAt: "2026-09-26",
    author,
    readingMinutes: 5,
    category: { en: "Supply Chain", ar: "سلسلة الإمداد" },
    related: { offerings: ["erp-ai-integration", "data-pipelines"], capabilities: ["supply-chain-optimization", "demand-planning"], caseStudies: [] },
    title: {
      en: "Safety Stock From Forecast Error, Step by Step",
      ar: "حساب مخزون الأمان من خطأ التوقع خطوة بخطوة",
    },
    excerpt: {
      en: "Fixed min/max levels hide both shortages and excess. Set safety stock from how wrong your forecast is and how long your suppliers really take.",
      ar: "مستويات الحد الأدنى والأقصى الثابتة تخفي النقص والزيادة معاً. حدّد مخزون الأمان من مدى خطأ توقعك ومن المهل الفعلية للموردين.",
    },
    keywords: {
      en: ["safety stock calculation", "inventory optimization manufacturing", "forecast error"],
      ar: ["حساب مخزون الأمان", "تحسين المخزون", "خطأ التوقع"],
    },
    body: {
      en: [
        { type: "p", text: "In many plants, min/max levels were set years ago and never revisited. The result is familiar: too much of the items that sell steadily, and shortages of the ones that don't." },
        { type: "h2", text: "Four steps" },
        { type: "ul", items: ["Measure forecast error per item: compare last months' forecast with actual demand.", "Measure real lead times from purchase orders and receipts, including how much they vary.", "Choose a service level per item class: high for items that stop the line, lower for the rest.", "Set safety stock from forecast error over the lead time and the chosen service level, then review it every quarter."] },
        { type: "p", text: "The standard formula multiplies a service-level factor by the variability of demand over the lead time. The formula is simple; the hard part is clean data on forecasts, orders and receipts — which usually sits in the ERP and a few spreadsheets." },
        { type: "h2", text: "Start small" },
        { type: "p", text: "Apply it to the 50 items that cause the most shortages or hold the most cash. Compare stock and shortages after one quarter before rolling it out." },
        { type: "quote", text: "Safety stock should come from how wrong your forecast is, not from how nervous the buyer feels." },
        { type: "tool", tool: "sop-scorecard" },
        { type: "cta", offering: "erp-ai-integration" },
      ],
      ar: [
        { type: "p", text: "في كثير من المصانع، وُضعت مستويات الحد الأدنى والأقصى قبل سنوات ولم تُراجع. والنتيجة معروفة: زيادة في الأصناف ذات البيع الثابت، ونقص في الأصناف الأخرى." },
        { type: "h2", text: "أربع خطوات" },
        { type: "ul", items: ["قِس خطأ التوقع لكل صنف: قارن توقع الأشهر الماضية بالطلب الفعلي.", "قِس مهل التوريد الفعلية من أوامر الشراء والاستلامات، ومدى تذبذبها.", "اختر مستوى خدمة لكل فئة أصناف: مرتفعاً للأصناف التي توقف الخط وأقل لغيرها.", "حدّد مخزون الأمان من خطأ التوقع خلال مهلة التوريد ومستوى الخدمة المختار، وراجعه كل ربع سنة."] },
        { type: "p", text: "المعادلة القياسية تضرب معامل مستوى الخدمة في تذبذب الطلب خلال مهلة التوريد. المعادلة بسيطة؛ الصعب هو البيانات النظيفة عن التوقعات والطلبات والاستلامات، وهي عادةً في ERP وبعض الجداول." },
        { type: "h2", text: "ابدأ صغيراً" },
        { type: "p", text: "طبّقها على الخمسين صنفاً الأكثر تسبباً في النقص أو احتجازاً للنقد. قارن المخزون والنقص بعد ربع سنة قبل التعميم." },
        { type: "quote", text: "مخزون الأمان يجب أن يأتي من مدى خطأ توقعك، لا من مدى قلق مسؤول المشتريات." },
        { type: "tool", tool: "sop-scorecard" },
        { type: "cta", offering: "erp-ai-integration" },
      ],
    },
