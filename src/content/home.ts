...
export const home = {
  ...
  h1: {
    en: ["AI-Powered Manufacturing Intelligence.", "Connected to Your ERP.", "Embedded Across Your Factory Systems."],
    ar: ["تصنيع ذكي مدعوم بالذكاء الاصطناعي.", "متصل بنظام ERP لديك.", "مدمج في جميع أنظمة مصنعك."],
  } as L10n<string[]>,
  h2: {
