...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between gap-4 py-5 text-start text-lg font-semibold transition-all hover:text-brand-teal-dark [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
